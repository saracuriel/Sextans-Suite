...
Sextans Sight creates a Metadata server following the FAIR Data Point specifications that provides automated agents with the ability to determine the utility of the contained resource (database, SKG, catalog, research object). The first step in navitation is deciding where you need to go!
